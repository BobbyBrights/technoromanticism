...
function twentysixteen_scripts() {
	...
	wp_enqueue_script( 'script-gen', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20160412', true );

	// my scripts

	//wp_enqueue_script( 'jquery' );

	//wp_enqueue_script( 'jquery-flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array( 'jquery' ), '20161005', true );

	wp_enqueue_script( 'jquery-flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js', array( 'jquery' ), '20161005', true );

	wp_enqueue_script( 'twentysixteen-script', get_template_directory_uri() . '/js/script.gen.js', array( 'jquery' ), '20161005', true );
