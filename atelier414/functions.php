...
/**
 * BreadCrumbs / Code pour fil d'arianne
 * Author : Daniel Roch
 */
 ...
 */
function resume() {
	$langue = qtrans_getLanguage();
	switch ($langue) {
		case 'pt':
			# Resume portugais
			$resume = "<!--:pt-->Projetos digitais e intervenções de François Labastie, professor de informática, desenvolvedor web (ferramentas colaborativas) e artista multimídia<!--:-->";
			break;

		case 'fr':
			# Resume francais
			$resume = "<!--:fr-->Projets numériques et interventions  de François Labastie, formateur, développeur web (outils collaboratifs) et artiste multimédia<!--:-->";
			break;
